...
<template>
  ...
  <div class="h-auto p-3 card-page">
    ...
    <div class="w-full mt-5">
      <h1 class="text-2xl font-medium text-gray-900 dark:text-gray-200">Card</h1>
    ...
    <div class="grid grid-cols-2 gap-5 mt-10">
      <div class="w-full p-5 bg-white rounded-md card dark:bg-gray-800">
        ...
        <div class="box-border w-full mt-4 wrapper-button">
          <div
            class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md card dark:bg-gray-800 dark:border-gray-700"
          >
            <a href="#">
      ...
      <div class="w-full p-5 bg-white rounded-md card dark:bg-gray-800">
        ...
        <div class="box-border w-full mt-4 wrapper-button">
          <div
            class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md card dark:bg-gray-800 dark:border-gray-700"
          >
            <a href="#">
